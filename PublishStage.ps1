...
Write-Host "                                                        "
Write-Host "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
Write-Host "SailTally Azure Pipelines Artifact Staging Tool         "
Write-Host "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
Write-Host "                                                        "
...
Write-Host "[Token Replacement]"
$oldContent = Get-Content -Path "$sourceFolder\web.config" -Raw
$newContent = $oldContent.Replace('$DBCONNSTR',"$sqlConnectionStr").Replace('$TRACKID',"$googleTrackId")
Set-Content -Path "$sourceFolder\web.config" -Value $newContent -Force
Write-Host
...
{
	Write-Host ":( Missing parameters to script."
	exit 1;
}

Write-Host ":) Script ended normally."
exit 0;
# ~End~
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUhBaxJrJ2swd2gikGHQjuJXKi
# Um6gghMHMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQkEMRYEFMjWtYMb2i96fryHIJ/htXruUOWRMA0GCSqGSIb3DQEBAQUABIIBAB9d
# ElxxkWF+vaUmWplDO9Lxv4E0iYAZOJWXqiFXjUwxXkYcugRnYYJ53OC7PcbgXr2Z
# 9huWBgt1dZaRgs/9kU86YSbbh9GHlLsOJG8HEruFBFHKgu/sPJFoeA6lCKl9Qkvd
# 5hpPzrZFTGV/bf4bvrC/5ND2TOXvMpP/VtkUQihAQ2yTedicAa2vu03EK3sBjc4D
# WnP+oTKx+ZH9UXCAX7lGDB6IAlgx08gDxS259+hwwVmDY+NL0jzB/DqDov3cfhFw
# vGieRSdsRVSbyCDJQklJK4beo2suS/p/fZDhOH/0QFN05OYfo09dqYSt8O9xHQv7
# ZosvgAoExG0/2c7hdAWhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEwaDBS
# MQswCQYDVQQGEwJCRTEZMBcGA1UEChMQR2xvYmFsU2lnbiBudi1zYTEoMCYGA1UE
...
# BgkqhkiG9w0BCQUxDxcNMjAwMjA3MjE0MzQ2WjAjBgkqhkiG9w0BCQQxFgQUeTfp
# wZK0iBqRUK5+FFLpvZXUBsMwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGEBBRj
...
# BIIBADzpWrCp+ZyFgYoMSjEJpoQ/2Y0B8YLyKobOzk5ZFbIgiESDFttSzhpsh6RW
# oMcWwCoctlZeKpqHhewvrIsRmRWPtIVNm5JvkRMpx3XHvTtdUsxBR02YDHIFK3as
# AnLwpCw4fXFknJ2NN9G8E8+4KgZJwcIUGZlCTKPRRc0iD5bwH8CDOg7Iwj4zjuAt
# 8iSMqKTw8d+yhusKYsX43ZxHnusclLWk3rCDdd6gttU/Uz/32C2K4K+0kMJVA4gT
# U5fegXppQI6EmL8sE8REot3mcSXJGdqUdRDW6hryvRfpaI9CKw4QXnhdgQcPqYz4
# GEa5Vu7M83vsBNm3wfRDbW7YNzY=
